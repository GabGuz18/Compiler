...
drag_box = DraggableRectangle(85, 510,100,50,"Si","Si")
drag_box2 = DraggableRectangle(205, 510,100,50,"Mientras","Mientras")
drag_box3 = DraggableRectangle(85, 590,100,50,"20",20)
drag_box4 = DraggableRectangle(205, 590,100,50,"Correr","Correr")
...
level__txt = pygame.image.load('Game/Img/Level_tree.png').convert_alpha()
comp = Compilador()
    ...
    while running:
        ...
        if rect1.Opcion != None:
            if start_button.draw(screen):
                ...
                opc2 = rect2.Opcion
                print(opc)
                error = comp.condicional(opc,opc2)
